"""
Milestone 4K Celebration Powers for Cosmic Encounter.

Special celebration aliens for reaching 4000 aliens!
"""
...
class FourThousand(AlienPower):
    """FourThousand - Power of Milestone."""
    name: str = field(default="FourThousand", init=False)
    description: str = field(default="+4 celebrating 4000.", init=False)
...
# Register all aliens
for alien_class in [
    FourThousand, Quadruple, Epoch, Summit, Zenith, Pinnacle,
]:
