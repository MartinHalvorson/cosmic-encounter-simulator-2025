"""
Plant Type themed alien powers for Cosmic Encounter.
"""
...
class Moss(AlienPower):
    """Moss - Power of Persistence."""
    name: str = field(default="Moss", init=False)
    description: str = field(default="Survive with 1 ship.", init=False)
...
@dataclass
class Thistle(AlienPower):
    """Thistle - Power of Thorns."""
    name: str = field(default="Thistle", init=False)
...
@dataclass
class Algae(AlienPower):
    """Algae - Power of Basics."""
    name: str = field(default="Algae", init=False)
...
# Register all aliens
for alien_class in [
    Sequoia, Bamboo, Cactus, Willow, Redwood, Fern,
    Moss, Ivy, Lotus, Thistle, Algae, Lily,
]:
