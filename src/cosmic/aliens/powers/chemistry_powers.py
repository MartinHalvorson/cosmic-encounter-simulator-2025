"""
Chemistry Powers - Chemical elements and compounds themed aliens.
"""
...
class Hydrogen(AlienPower):
    """Hydrogen - Power of Element 1. +1 always."""
...
class Helium(AlienPower):
    """Helium - Power of Lightness. Ships escape."""
...
class Nitrogen(AlienPower):
    """Nitrogen - Power of Air. +3 on defense."""
...
class Oxygen(AlienPower):
    """Oxygen - Power of Breath. +4 on offense."""
...
class Fluorine(AlienPower):
    """Fluorine - Power of Reactivity. -3 to opponent."""
...
class Neon(AlienPower):
    """Neon - Power of Light. See opponent card."""
...
class Magnesium(AlienPower):
    """Magnesium - Power of Brightness. +5 on offense."""
...
class Silicon(AlienPower):
    """Silicon - Power of Computing. +5 always."""
...
class Chlorine(AlienPower):
    """Chlorine - Power of Poison. -2 to attacker."""
...
class Argon(AlienPower):
    """Argon - Power of Inertness. +4 on defense."""
...
class Potassium(AlienPower):
    """Potassium - Power of Energy. Random +1 to +5."""
...
class Calcium(AlienPower):
    """Calcium - Power of Bones. +4 on defense."""
...
class Phosphorus(AlienPower):
    """Phosphorus - Power of Glow. +6 always."""
...
CHEMISTRY_POWERS = [
    ...
    Magnesium, Silicon, Chlorine, Argon, Potassium, Calcium, Phosphorus,
]
