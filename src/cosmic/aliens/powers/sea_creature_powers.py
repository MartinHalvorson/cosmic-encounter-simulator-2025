"""
Sea Creature Powers for Cosmic Encounter.
"""
...
class Octopus(AlienPower):
    """Octopus - Power of Arms. +4 always."""
...
class Jellyfish(AlienPower):
    """Jellyfish - Power of Sting. +4 on offense."""
...
class Crab(AlienPower):
    """Crab - Power of Pinch. +4 on defense."""
...
class Lobster(AlienPower):
    """Lobster - Power of Claw. +5 on defense."""
...
class Squid(AlienPower):
    """Squid - Power of Ink. +4 on defense."""
...
class Starfish(AlienPower):
    """Starfish - Power of Regenerate. +3 always."""
...
@dataclass
class SeaUrchin(AlienPower):
    """SeaUrchin - Power of Spine. +5 on defense."""
    name: str = field(default="SeaUrchin", init=False)
    description: str = field(default="+5 when defending.", init=False)
    timing: PowerTiming = field(default=PowerTiming.RESOLUTION, init=False)
    power_type: PowerType = field(default=PowerType.MANDATORY, init=False)
    category: PowerCategory = field(default=PowerCategory.YELLOW, init=False)
...
class Oyster(AlienPower):
    """Oyster - Power of Pearl. +4 always."""
...
class Clam(AlienPower):
    """Clam - Power of Shell. +4 on defense."""
...
@dataclass
class Shrimp(AlienPower):
    """Shrimp - Power of Small. +2 always."""
    name: str = field(default="Shrimp", init=False)
...
class Dolphin(AlienPower):
    """Dolphin - Power of Intelligence. +4 always."""
...
class Walrus(AlienPower):
    """Walrus - Power of Tusk. +4 on offense."""
...
SEA_CREATURE_POWERS = [
    Octopus, Jellyfish, Crab, Lobster, Squid,
    Starfish, SeaUrchin, Oyster, Clam, Shrimp,
    Whale, Dolphin, Seal, Walrus,
]

for power_class in SEA_CREATURE_POWERS:
    try:
