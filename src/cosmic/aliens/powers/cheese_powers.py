"""
Cheese Powers - Cheese themed aliens.
"""
...
class Mozzarella(AlienPower):
    """Mozzarella - Stretchy Cheese. +3 always."""
...
class Gouda(AlienPower):
    """Gouda - Smooth Cheese. +4 on defense."""
...
class Feta(AlienPower):
    """Feta - Crumbly Cheese. +3 on offense."""
...
@dataclass
class Swiss(AlienPower):
    """Swiss - Holey Cheese. Random +2 to +5."""
    name: str = field(default="Swiss", init=False)
...
@dataclass
class Gorgonzola(AlienPower):
    """Gorgonzola - Blue Cheese. +4 on offense."""
    name: str = field(default="Gorgonzola", init=False)
...
class Camembert(AlienPower):
    """Camembert - Creamy Cheese. +4 on defense."""
...
class Ricotta(AlienPower):
    """Ricotta - Fresh Cheese. +3 on defense."""
...
@dataclass
class Mascarpone(AlienPower):
    """Mascarpone - Rich Cheese. +4 on offense."""
    name: str = field(default="Mascarpone", init=False)
    description: str = field(default="+4 when attacking.", init=False)
    timing: PowerTiming = field(default=PowerTiming.REVEAL, init=False)
    power_type: PowerType = field(default=PowerType.MANDATORY, init=False)
    category: PowerCategory = field(default=PowerCategory.GREEN, init=False)
...
class Provolone(AlienPower):
    """Provolone - Smoked Cheese. +3 always."""
...
class Manchego(AlienPower):
    """Manchego - Spanish Cheese. +4 always."""
...
class Halloumi(AlienPower):
    """Halloumi - Grilling Cheese. +5 on offense."""
...
# Register all powers
CHEESE_POWERS = [
    Cheddar, Brie, Mozzarella, Parmesan, Gouda, Feta, Swiss, Gorgonzola,
    Camembert, Gruyere, Ricotta, Mascarpone, Provolone, Manchego, Halloumi,
]

for power_class in CHEESE_POWERS:
    try:
