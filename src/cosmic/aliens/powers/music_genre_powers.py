"""
Music Genre Powers for Cosmic Encounter.
"""
...
class Rock_Music(AlienPower):
    """Rock_Music - Power of Loud. +5 on offense."""
...
class Jazz_Music(AlienPower):
    """Jazz_Music - Power of Improvise. +5 always."""
...
class Classical_Music(AlienPower):
    """Classical_Music - Power of Compose. +6 always."""
...
class Blues_Music(AlienPower):
    """Blues_Music - Power of Soul. +5 always."""
...
class Country_Music(AlienPower):
    """Country_Music - Power of Story. +5 always."""
...
class Electronic_Music(AlienPower):
    """Electronic_Music - Power of Beat. +5 on offense."""
...
class Hip_Hop_Music(AlienPower):
    """Hip_Hop_Music - Power of Flow. +5 always."""
...
class Reggae_Music(AlienPower):
    """Reggae_Music - Power of Chill. +5 on defense."""
...
class Metal_Music(AlienPower):
    """Metal_Music - Power of Heavy. +6 on offense."""
...
class Folk_Music(AlienPower):
    """Folk_Music - Power of Acoustic. +4 always."""
...
class Punk_Music(AlienPower):
    """Punk_Music - Power of Rebel. +5 on offense."""
...
class Soul_Music(AlienPower):
    """Soul_Music - Power of Feeling. +5 always."""
...
class Funk_Music(AlienPower):
    """Funk_Music - Power of Groove. +5 always."""
...
class Opera_Music(AlienPower):
    """Opera_Music - Power of Voice. +6 always."""
...
MUSIC_GENRE_POWERS = [
    Rock_Music, Jazz_Music, Classical_Music, Blues_Music, Country_Music, Electronic_Music, Hip_Hop_Music,
    Reggae_Music, Metal_Music, Folk_Music, Punk_Music, Soul_Music, Funk_Music, Opera_Music,
]
