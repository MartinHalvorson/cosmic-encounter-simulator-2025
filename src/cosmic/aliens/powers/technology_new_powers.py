"""
New Technology Powers for Cosmic Encounter.

More aliens inspired by technology and computing.
"""
...
@dataclass
class Memory_Tech(AlienPower):
    """Memory_Tech - Power of Storage."""
    name: str = field(default="Memory_Tech", init=False)
...
@dataclass
class Network_Tech(AlienPower):
    """Network_Tech - Power of Connection."""
    name: str = field(default="Network_Tech", init=False)
...
@dataclass
class Virus_Tech(AlienPower):
    """Virus_Tech - Power of Spread."""
    name: str = field(default="Virus_Tech", init=False)
...
@dataclass
class Cloud_Tech(AlienPower):
    """Cloud_Tech - Power of Everywhere."""
    name: str = field(default="Cloud_Tech", init=False)
    description: str = field(default="+4 always.", init=False)
    timing: PowerTiming = field(default=PowerTiming.RESOLUTION, init=False)
    power_type: PowerType = field(default=PowerType.MANDATORY, init=False)
    category: PowerCategory = field(default=PowerCategory.GREEN, init=False)
...
@dataclass
class Blockchain(AlienPower):
    """Blockchain - Power of Trust."""
    name: str = field(default="Blockchain", init=False)
...
# Register all aliens
for alien_class in [
    Processor, Memory_Tech, Network_Tech, Firewall, Virus_Tech,
    Database, Bandwidth, Cache, Server, Cloud_Tech,
    Quantum, Blockchain,
]:
