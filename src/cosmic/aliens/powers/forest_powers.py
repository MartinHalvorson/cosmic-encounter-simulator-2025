"""
Forest Powers - Forest/woodland themed aliens.
"""
...
class Birch(AlienPower):
    """Birch - White Bark Tree. +3 always."""
...
class Willow(AlienPower):
    """Willow - Weeping Tree. +4 on defense."""
...
class Redwood(AlienPower):
    """Redwood - Giant Tree. +6 on defense."""
...
class Moss(AlienPower):
    """Moss - Forest Floor. +3 on defense."""
...
class Acorn(AlienPower):
    """Acorn - Tree Seed. Extra card draw."""
...
@dataclass
class Mushroom_Forest(AlienPower):
    """Mushroom_Forest - Forest Fungi. Random +2 to +5."""
    name: str = field(default="Mushroom_Forest", init=False)
...
@dataclass
class Clearing(AlienPower):
    """Clearing - Open Space. Ships escape."""
    name: str = field(default="Clearing", init=False)
...
# Register all powers
FOREST_POWERS = [
    Oak, Pine, Maple, Birch, Willow, Redwood, Sequoia, Cedar, Ash_Tree,
    Elm, Moss, Fern, Acorn, Mushroom_Forest, Clearing,
]

for power_class in FOREST_POWERS:
    try:
