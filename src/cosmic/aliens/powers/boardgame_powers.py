...
@dataclass
class Monopoly_Game(AlienPower):
    """Monopoly_Game - Property Game. Extra card draw."""
    name: str = field(default="Monopoly_Game", init=False)
...
class Risk(AlienPower):
    """Risk - World Conquest. +4 on offense."""
...
class Checkers(AlienPower):
    """Checkers - Classic Game. +3 always."""
...
class Backgammon(AlienPower):
    """Backgammon - Ancient Game. Random +2 to +6."""
...
@dataclass
class Go(AlienPower):
    """Go - Territory Game. +5 on defense."""
    name: str = field(default="Go", init=False)
...
class Battleship(AlienPower):
    """Battleship - Naval Combat. +4 on offense."""
...
class Clue(AlienPower):
    """Clue - Mystery Game. See opponent card."""
...
@dataclass
class Yahtzee(AlienPower):
    """Yahtzee - Dice Game. Random +1 to +6."""
    name: str = field(default="Yahtzee", init=False)
...
@dataclass
class Stratego(AlienPower):
    """Stratego - Military Game. +4 on offense."""
    name: str = field(default="Stratego", init=False)
    description: str = field(default="+4 when attacking.", init=False)
    timing: PowerTiming = field(default=PowerTiming.REVEAL, init=False)
    power_type: PowerType = field(default=PowerType.MANDATORY, init=False)
    category: PowerCategory = field(default=PowerCategory.GREEN, init=False)
...
class Mahjong(AlienPower):
    """Mahjong - Tile Game. +4 on defense."""
...
# Register all powers
BOARDGAME_POWERS = [
    Chess, Monopoly_Game, Risk, Catan, Scrabble, Checkers, Backgammon,
    Go, Battleship, Clue, Yahtzee, Pandemic, Stratego, Dominoes, Mahjong,
]

for power_class in BOARDGAME_POWERS:
    try:
