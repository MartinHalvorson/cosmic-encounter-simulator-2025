"""
Nature themed alien powers - Pack 1 (50 aliens).
"""
...
class Cedar(AlienPower):
    """Cedar - Aromatic. +4 defending home."""
...
@dataclass
class Palm(AlienPower):
    """Palm - Tropical. +3 attacking."""
    name: str = field(default="Palm", init=False)
    description: str = field(default="+3 attacking.", init=False)
    timing: PowerTiming = field(default=PowerTiming.REVEAL, init=False)
    power_type: PowerType = field(default=PowerType.MANDATORY, init=False)
    category: PowerCategory = field(default=PowerCategory.GREEN, init=False)
...
@dataclass
class Ivy(AlienPower):
    """Ivy - Climbing. +2 attacking."""
    name: str = field(default="Ivy", init=False)
    description: str = field(default="+2 attacking.", init=False)
    timing: PowerTiming = field(default=PowerTiming.REVEAL, init=False)
    power_type: PowerType = field(default=PowerType.MANDATORY, init=False)
    category: PowerCategory = field(default=PowerCategory.GREEN, init=False)
...
class Bamboo(AlienPower):
    """Bamboo - Fast grower. +5 attacking."""
...
class Cactus(AlienPower):
    """Cactus - Desert survivor. +4 defending."""
...
class Orchid(AlienPower):
    """Orchid - Exotic bloom. +3 attacking."""
...
class Sunflower(AlienPower):
    """Sunflower - Sun tracker. +4 attacking."""
...
class Daisy(AlienPower):
    """Daisy - Simple beauty. +2 defending."""
...
class Lily(AlienPower):
    """Lily - Elegant flower. +3 defending."""
...
@dataclass
class Peony(AlienPower):
    """Peony - Lush bloom. +4 always."""
    name: str = field(default="Peony", init=False)
    description: str = field(default="+4 in encounters.", init=False)
    timing: PowerTiming = field(default=PowerTiming.REVEAL, init=False)
    power_type: PowerType = field(default=PowerType.MANDATORY, init=False)
    category: PowerCategory = field(default=PowerCategory.GREEN, init=False)
...
class Magnolia(AlienPower):
    """Magnolia - Ancient flower. +5 always."""
...
@dataclass
class Stream(AlienPower):
    """Stream - Trickling water. +2 always."""
    name: str = field(default="Stream", init=False)
    description: str = field(default="+2 in encounters.", init=False)
    timing: PowerTiming = field(default=PowerTiming.REVEAL, init=False)
    power_type: PowerType = field(default=PowerType.MANDATORY, init=False)
    category: PowerCategory = field(default=PowerCategory.GREEN, init=False)
...
class Waterfall(AlienPower):
    """Waterfall - Crashing water. +5 attacking."""
...
class Mountain(AlienPower):
    """Mountain - Towering peak. +5 defending."""
...
class Cave(AlienPower):
    """Cave - Dark refuge. +5 defending home."""
...
class Tundra(AlienPower):
    """Tundra - Frozen plain. +4 defending."""
...
class Glacier(AlienPower):
    """Glacier - Frozen river. +5 defending."""
...
class Volcano(AlienPower):
    """Volcano - Erupting mountain. +6 attacking."""
...
class Island(AlienPower):
    """Island - Isolated land. +4 defending home."""
...
class Reef(AlienPower):
    """Reef - Coral formation. +3 defending."""
...
NATURE_PACK_POWERS = [
    Oak, Pine, Willow, Maple, Birch, Cedar, Redwood, Palm, Fern, Moss,
    Ivy, Bamboo, Cactus, Rose, Lotus, Orchid, Tulip, Sunflower, Daisy, Lily,
    Violet, Jasmine, Lavender, Peony, Magnolia, River, Ocean, Lake, Stream, Waterfall,
    Pond, Mountain, Valley, Hill, Canyon, Cliff, Cave, Desert, Jungle, Swamp,
    Meadow, Prairie, Tundra, Glacier, Volcano, Island, Reef,
]

for power_class in NATURE_PACK_POWERS:
    try:
