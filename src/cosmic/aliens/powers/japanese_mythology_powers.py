"""
Japanese Mythology Powers - Japanese gods and spirits themed aliens.
"""
...
class Amaterasu(AlienPower):
    """Amaterasu - Sun goddess. +4 on offense."""
...
class Susanoo(AlienPower):
    """Susanoo - Storm god. +5 offense, -2 defense."""
...
class Izanagi(AlienPower):
    """Izanagi - Creator god. +2 per home colony."""
...
class Izanami(AlienPower):
    """Izanami - Death goddess. Ships go home."""
...
class Raijin(AlienPower):
    """Raijin - Thunder god. Random +0 to +6."""
...
@dataclass
class Hachiman(AlienPower):
    """Hachiman - War god. +3 first encounter."""
    name: str = field(default="Hachiman", init=False)
...
class Benzaiten(AlienPower):
    """Benzaiten - Music goddess. +1 per card."""
...
class Kitsune(AlienPower):
    """Kitsune - Fox spirit. See opponent card."""
...
@dataclass
class Ryujin(AlienPower):
    """Ryujin - Dragon god. Win ties."""
    name: str = field(default="Ryujin", init=False)
...
JAPANESE_MYTHOLOGY_POWERS = [
    ...
    Raijin, Fujin, Hachiman, Ebisu, Benzaiten, Kitsune,
    Tengu, Oni, Ryujin,
]
