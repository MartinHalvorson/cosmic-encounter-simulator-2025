"""
Gemstone Powers - Precious gem themed aliens.
"""
...
class Emerald_Gem(AlienPower):
    """Emerald_Gem - Green Gem. +5 always."""
...
class Opal(AlienPower):
    """Opal - Rainbow Gem. Random +2 to +6."""
...
class Turquoise(AlienPower):
    """Turquoise - Blue-Green Gem. +4 on defense."""
...
class Aquamarine(AlienPower):
    """Aquamarine - Ocean Gem. Ships escape."""
...
@dataclass
class Peridot(AlienPower):
    """Peridot - Green Gem. +3 always."""
    name: str = field(default="Peridot", init=False)
...
class Citrine(AlienPower):
    """Citrine - Yellow Gem. Extra card draw."""
...
class Moonstone(AlienPower):
    """Moonstone - Lunar Gem. +4 on defense."""
...
@dataclass
class Tanzanite(AlienPower):
    """Tanzanite - Rare Blue Gem. +5 always."""
    name: str = field(default="Tanzanite", init=False)
    description: str = field(default="+5 constant.", init=False)
    timing: PowerTiming = field(default=PowerTiming.REVEAL, init=False)
    power_type: PowerType = field(default=PowerType.MANDATORY, init=False)
    category: PowerCategory = field(default=PowerCategory.YELLOW, init=False)
...
@dataclass
class Alexandrite(AlienPower):
    """Alexandrite - Color-Change Gem. +5 always."""
    name: str = field(default="Alexandrite", init=False)
    description: str = field(default="+5 constant.", init=False)
    timing: PowerTiming = field(default=PowerTiming.REVEAL, init=False)
    power_type: PowerType = field(default=PowerType.MANDATORY, init=False)
    category: PowerCategory = field(default=PowerCategory.YELLOW, init=False)
...
@dataclass
class Zircon(AlienPower):
    """Zircon - Diamond Alternative. +4 always."""
    name: str = field(default="Zircon", init=False)
    description: str = field(default="+4 constant.", init=False)
    timing: PowerTiming = field(default=PowerTiming.REVEAL, init=False)
    power_type: PowerType = field(default=PowerType.MANDATORY, init=False)
    category: PowerCategory = field(default=PowerCategory.GREEN, init=False)
...
# Register all powers
GEMSTONE_POWERS = [
    Emerald_Gem, Amethyst, Topaz, Opal, Onyx, Garnet, Turquoise, Jade,
    Aquamarine, Peridot, Citrine, Moonstone, Tanzanite, Alexandrite, Zircon,
]
