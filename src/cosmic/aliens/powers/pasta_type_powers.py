"""
Pasta Type Powers for Cosmic Encounter.
"""
...
class Spaghetti_Pasta(AlienPower):
    """Spaghetti_Pasta - Power of Long. +5 always."""
...
class Penne_Pasta(AlienPower):
    """Penne_Pasta - Power of Tube. +5 always."""
...
class Fusilli_Pasta(AlienPower):
    """Fusilli_Pasta - Power of Spiral. +5 always."""
...
class Rigatoni_Pasta(AlienPower):
    """Rigatoni_Pasta - Power of Ridged. +5 on defense."""
...
class Farfalle_Pasta(AlienPower):
    """Farfalle_Pasta - Power of Bow. +5 always."""
...
class Linguine_Pasta(AlienPower):
    """Linguine_Pasta - Power of Flat. +5 always."""
...
class Fettuccine_Pasta(AlienPower):
    """Fettuccine_Pasta - Power of Ribbon. +5 always."""
...
class Ravioli_Pasta(AlienPower):
    """Ravioli_Pasta - Power of Stuffed. +6 always."""
...
class Tortellini_Pasta(AlienPower):
    """Tortellini_Pasta - Power of Ring. +5 always."""
...
class Lasagna_Pasta(AlienPower):
    """Lasagna_Pasta - Power of Layer. +6 on defense."""
...
class Orzo_Pasta(AlienPower):
    """Orzo_Pasta - Power of Rice. +4 always."""
...
class Gnocchi_Pasta(AlienPower):
    """Gnocchi_Pasta - Power of Dumpling. +5 always."""
...
class Cannelloni_Pasta(AlienPower):
    """Cannelloni_Pasta - Power of Roll. +5 always."""
...
class Macaroni_Pasta(AlienPower):
    """Macaroni_Pasta - Power of Elbow. +5 always."""
...
PASTA_TYPE_POWERS = [
    Spaghetti_Pasta, Penne_Pasta, Fusilli_Pasta, Rigatoni_Pasta, Farfalle_Pasta, Linguine_Pasta, Fettuccine_Pasta,
    Ravioli_Pasta, Tortellini_Pasta, Lasagna_Pasta, Orzo_Pasta, Gnocchi_Pasta, Cannelloni_Pasta, Macaroni_Pasta,
]
