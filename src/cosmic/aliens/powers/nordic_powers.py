"""
Nordic Powers - Norse mythology themed aliens.
"""
...
class Thor_Alt(AlienPower):
    """Thor_Alt - Thunder God. +5 on offense."""
...
class Heimdall(AlienPower):
    """Heimdall - Watchman. See opponent card."""
...
class Hel(AlienPower):
    """Hel - Death Goddess. -3 to opponent."""
...
class Fenrir(AlienPower):
    """Fenrir - Giant Wolf. +6 on offense."""
...
class Jormungandr(AlienPower):
    """Jormungandr - World Serpent. +5 on defense."""
...
class Valkyrie(AlienPower):
    """Valkyrie - Chooser of Slain. Return 1 ship from warp."""
...
class Yggdrasil(AlienPower):
    """Yggdrasil - World Tree. +3 per colony."""
...
class Mjolnir(AlienPower):
    """Mjolnir - Thunder Hammer. +5 always."""
...
class Rune(AlienPower):
    """Rune - Magic Symbol. Extra card draw."""
...
class Einherjar(AlienPower):
    """Einherjar - Fallen Warriors. +1 per ship."""
...
# Register all powers
NORDIC_POWERS = [
    Odin, Thor_Alt, Loki_Alt, Freya, Heimdall, Tyr, Baldur, Hel, Fenrir,
    Jormungandr, Valkyrie, Yggdrasil, Mjolnir, Rune, Einherjar,
]

for power_class in NORDIC_POWERS:
    try:
