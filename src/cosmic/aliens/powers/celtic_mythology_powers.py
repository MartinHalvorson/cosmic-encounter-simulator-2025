"""
Celtic Mythology Powers - Celtic gods and spirits themed aliens.
"""
...
class Morrigan(AlienPower):
    """Morrigan - War goddess. +5 offense, -2 defense."""
...
class Lugh(AlienPower):
    """Lugh - Master craftsman. +2 always."""
...
class Brigid(AlienPower):
    """Brigid - Fire goddess. +4 on defense."""
...
class Cernunnos(AlienPower):
    """Cernunnos - Horned god. +3 defending home."""
...
class Danu(AlienPower):
    """Danu - Mother goddess. +2 per home colony."""
...
@dataclass
class Manannán(AlienPower):
    """Manannán - Sea god. Ships go home."""
    name: str = field(default="Manannán", init=False)
...
@dataclass
class Nuada(AlienPower):
    """Nuada - King of gods. +3 first encounter."""
    name: str = field(default="Nuada", init=False)
...
@dataclass
class Balor(AlienPower):
    """Balor - Evil eye. -2 to opponent."""
    name: str = field(default="Balor", init=False)
...
@dataclass
class Aengus(AlienPower):
    """Aengus - Love god. +1 per ally."""
    name: str = field(default="Aengus", init=False)
...
class Arawn(AlienPower):
    """Arawn - Underworld king. Retrieve 3 ships."""
...
@dataclass
class Gwydion(AlienPower):
    """Gwydion - Trickster. Random +0 to +6."""
    name: str = field(default="Gwydion", init=False)
...
@dataclass
class Epona(AlienPower):
    """Epona - Horse goddess. Win ties."""
    name: str = field(default="Epona", init=False)
...
@dataclass
class Rhiannon(AlienPower):
    """Rhiannon - Queen goddess. See opponent card."""
    name: str = field(default="Rhiannon", init=False)
...
@dataclass
class Taranis(AlienPower):
    """Taranis - Thunder god. +1 per card."""
    name: str = field(default="Taranis", init=False)
...
# Register all powers
CELTIC_MYTHOLOGY_POWERS = [
    Dagda, Morrigan, Lugh, Brigid, Cernunnos, Danu, Manannán, Nuada,
    Balor, Aengus, Arawn, Gwydion, Epona, Rhiannon, Taranis,
]

for power_class in CELTIC_MYTHOLOGY_POWERS:
    try:
