"""
Mythology Greek Powers - Greek creature themed aliens.
"""
...
class Minotaur(AlienPower):
    """Minotaur - Bull Monster. +5 on offense."""
...
class Medusa(AlienPower):
    """Medusa - Stone Gaze. -3 to opponent."""
...
class Hydra(AlienPower):
    """Hydra - Many Heads. Return 1 ship from warp."""
...
class Cyclops(AlienPower):
    """Cyclops - One Eye Giant. +5 on offense."""
...
@dataclass
class Siren_Creature(AlienPower):
    """Siren_Creature - Luring Singer. See opponent card."""
    name: str = field(default="Siren_Creature", init=False)
...
class Cerberus(AlienPower):
    """Cerberus - Three-Head Dog. +5 on defense."""
...
class Pegasus(AlienPower):
    """Pegasus - Flying Horse. Ships escape."""
...
class Chimera(AlienPower):
    """Chimera - Mixed Monster. Random +2 to +6."""
...
@dataclass
class Satyr(AlienPower):
    """Satyr - Goat Being. +3 always."""
    name: str = field(default="Satyr", init=False)
...
class Gorgon(AlienPower):
    """Gorgon - Snake Hair. +4 on offense."""
...
class Sphinx(AlienPower):
    """Sphinx - Riddle Beast. See opponent card."""
...
# Register all powers
MYTHOLOGY_GREEK_POWERS = [
    Minotaur, Medusa, Hydra, Cyclops, Centaur, Siren_Creature, Cerberus,
    Pegasus, Chimera, Satyr, Nymph, Titan, Gorgon, Harpy, Sphinx,
]

for power_class in MYTHOLOGY_GREEK_POWERS:
    try:
