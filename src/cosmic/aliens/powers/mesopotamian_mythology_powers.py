"""
Mesopotamian Mythology Powers - Sumerian/Babylonian gods themed aliens.
"""
...
class Marduk(AlienPower):
    """Marduk - King of gods. +4 on offense."""
...
class Ishtar(AlienPower):
    """Ishtar - Love goddess. +1 per ally."""
...
class Enlil(AlienPower):
    """Enlil - Wind god. +5 offense, -2 defense."""
...
class Ereshkigal(AlienPower):
    """Ereshkigal - Underworld queen. Retrieve 3 ships."""
...
class Sin_Moon(AlienPower):
    """Sin_Moon - Moon god. +4 on defense."""
...
@dataclass
class Adad(AlienPower):
    """Adad - Storm god. Random +0 to +6."""
    name: str = field(default="Adad", init=False)
...
class Nabu(AlienPower):
    """Nabu - Wisdom god. See opponent card."""
...
class Tiamat(AlienPower):
    """Tiamat - Chaos dragon. +3 first encounter."""
...
@dataclass
class Ninhursag(AlienPower):
    """Ninhursag - Earth mother. +3 defending home."""
    name: str = field(default="Ninhursag", init=False)
...
@dataclass
class Girru(AlienPower):
    """Girru - Fire god. +1 per card."""
    name: str = field(default="Girru", init=False)
...
# Register all powers
MESOPOTAMIAN_MYTHOLOGY_POWERS = [
    Marduk, Ishtar, Enlil, Enki, Nergal, Ereshkigal, Shamash,
    Sin_Moon, Adad, Nabu, Tiamat, Anu, Ninurta, Ninhursag, Girru,
]

for power_class in MESOPOTAMIAN_MYTHOLOGY_POWERS:
    try:
