"""
Animal themed alien powers - Pack 1 (50 aliens).
"""
...
class Lion(AlienPower):
    """Lion - King of beasts. +6 attacking."""
...
@dataclass
class Tiger(AlienPower):
    """Tiger - Striped hunter. +5 attacking."""
    name: str = field(default="Tiger", init=False)
...
class Shark(AlienPower):
    """Shark - Ocean predator. +6 attacking."""
...
class Dolphin(AlienPower):
    """Dolphin - Smart swimmer. +4 always."""
...
class Elephant(AlienPower):
    """Elephant - Mighty beast. +6 always."""
...
class Rhino(AlienPower):
    """Rhino - Charging beast. +5 attacking."""
...
@dataclass
class Hippo(AlienPower):
    """Hippo - River beast. +5 defending."""
    name: str = field(default="Hippo", init=False)
...
@dataclass
class Giraffe(AlienPower):
    """Giraffe - Tall watcher. +3 always."""
    name: str = field(default="Giraffe", init=False)
    description: str = field(default="+3 in encounters.", init=False)
    timing: PowerTiming = field(default=PowerTiming.REVEAL, init=False)
    power_type: PowerType = field(default=PowerType.MANDATORY, init=False)
    category: PowerCategory = field(default=PowerCategory.GREEN, init=False)
...
@dataclass
class Zebra(AlienPower):
    """Zebra - Striped runner. +3 always."""
    name: str = field(default="Zebra", init=False)
    description: str = field(default="+3 in encounters.", init=False)
    timing: PowerTiming = field(default=PowerTiming.REVEAL, init=False)
    power_type: PowerType = field(default=PowerType.MANDATORY, init=False)
    category: PowerCategory = field(default=PowerCategory.GREEN, init=False)
...
@dataclass
class Cheetah(AlienPower):
    """Cheetah - Speed king. +5 attacking."""
    name: str = field(default="Cheetah", init=False)
    description: str = field(default="+5 attacking.", init=False)
    timing: PowerTiming = field(default=PowerTiming.REVEAL, init=False)
    power_type: PowerType = field(default=PowerType.MANDATORY, init=False)
    category: PowerCategory = field(default=PowerCategory.YELLOW, init=False)
...
@dataclass
class Leopard(AlienPower):
    """Leopard - Spotted hunter. +4 attacking."""
    name: str = field(default="Leopard", init=False)
    description: str = field(default="+4 attacking.", init=False)
    timing: PowerTiming = field(default=PowerTiming.REVEAL, init=False)
    power_type: PowerType = field(default=PowerType.MANDATORY, init=False)
    category: PowerCategory = field(default=PowerCategory.GREEN, init=False)
...
class Panther(AlienPower):
    """Panther - Dark hunter. +4 attacking."""
...
class Monkey(AlienPower):
    """Monkey - Clever climber. +3 always."""
...
@dataclass
class Ape(AlienPower):
    """Ape - Strong primate. +4 always."""
    name: str = field(default="Ape", init=False)
    description: str = field(default="+4 in encounters.", init=False)
    timing: PowerTiming = field(default=PowerTiming.REVEAL, init=False)
    power_type: PowerType = field(default=PowerType.MANDATORY, init=False)
    category: PowerCategory = field(default=PowerCategory.GREEN, init=False)
...
class Viper(AlienPower):
    """Viper - Quick strike. +4 attacking."""
...
class Crocodile(AlienPower):
    """Crocodile - Ancient predator. +5 attacking."""
...
class Alligator(AlienPower):
    """Alligator - Swamp hunter. +5 defending."""
...
class Turtle(AlienPower):
    """Turtle - Shell defender. +5 defending."""
...
class Tortoise(AlienPower):
    """Tortoise - Slow and steady. +4 defending."""
...
@dataclass
class Frog(AlienPower):
    """Frog - Leaper. +2 always."""
    name: str = field(default="Frog", init=False)
...
@dataclass
class Toad(AlienPower):
    """Toad - Warty. +2 defending."""
    name: str = field(default="Toad", init=False)
    description: str = field(default="+2 defending.", init=False)
    timing: PowerTiming = field(default=PowerTiming.REVEAL, init=False)
    power_type: PowerType = field(default=PowerType.MANDATORY, init=False)
    category: PowerCategory = field(default=PowerCategory.GREEN, init=False)
...
class Salamander(AlienPower):
    """Salamander - Fire spirit. +3 always."""
...
class Chameleon(AlienPower):
    """Chameleon - Color changer. +3 always."""
...
class Iguana(AlienPower):
    """Iguana - Tropical lizard. +3 defending."""
...
class Komodo(AlienPower):
    """Komodo - Giant lizard. +6 attacking."""
...
class Scorpion(AlienPower):
    """Scorpion - Venomous tail. +4 attacking."""
...
class Beetle(AlienPower):
    """Beetle - Armored insect. +3 defending."""
...
ANIMAL_PACK_POWERS = [
    Lion, Tiger, Bear, Wolf, Fox, Eagle, Hawk, Owl, Falcon, Raven,
    Shark, Whale, Dolphin, Octopus, Squid, Crab, Lobster, Elephant, Rhino, Hippo,
    Giraffe, Zebra, Cheetah, Leopard, Panther, Gorilla, Monkey, Ape, Snake, Python,
    Cobra, Viper, Crocodile, Alligator, Turtle, Tortoise, Frog, Toad, Salamander, Lizard,
    Gecko, Chameleon, Iguana, Komodo, Scorpion, Beetle,
]

for power_class in ANIMAL_PACK_POWERS:
    try:
