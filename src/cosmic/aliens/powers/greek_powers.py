"""
Greek Powers - Greek mythology themed aliens.
"""
...
class Hades(AlienPower):
    """Hades - Underworld God. -3 to opponent."""
...
class Aphrodite(AlienPower):
    """Aphrodite - Love Goddess. +2 per ally."""
...
class Hermes(AlienPower):
    """Hermes - Messenger God. See opponent card."""
...
@dataclass
class Apollo_Greek(AlienPower):
    """Apollo_Greek - Sun God. +5 always."""
    name: str = field(default="Apollo_Greek", init=False)
    description: str = field(default="+5 constant.", init=False)
    timing: PowerTiming = field(default=PowerTiming.REVEAL, init=False)
    power_type: PowerType = field(default=PowerType.MANDATORY, init=False)
    category: PowerCategory = field(default=PowerCategory.YELLOW, init=False)
...
class Artemis(AlienPower):
    """Artemis - Hunt Goddess. +4 on offense."""
...
class Hephaestus(AlienPower):
    """Hephaestus - Forge God. +4 on defense."""
...
class Hera(AlienPower):
    """Hera - Queen of Gods. +5 on defense."""
...
class Demeter(AlienPower):
    """Demeter - Harvest Goddess. Extra card draw."""
...
class Dionysus(AlienPower):
    """Dionysus - Wine God. Random +1 to +6."""
...
class Hestia(AlienPower):
    """Hestia - Hearth Goddess. Return 1 ship from warp."""
...
class Persephone(AlienPower):
    """Persephone - Spring Goddess. +4 always."""
...
# Register all powers
GREEK_POWERS = [
    Zeus, Poseidon, Hades, Athena, Ares, Aphrodite, Hermes, Apollo_Greek,
    Artemis, Hephaestus, Hera, Demeter, Dionysus, Hestia, Persephone,
]
