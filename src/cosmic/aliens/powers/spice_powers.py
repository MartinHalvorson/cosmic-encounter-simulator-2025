"""
Spice themed alien powers for Cosmic Encounter.
"""
...
@dataclass
class ChiliSpice(AlienPower):
    name: str = field(default="Chili_Spice", init=False)
...
@dataclass
class Cloves(AlienPower):
    name: str = field(default="Cloves", init=False)
...
@dataclass
class SageSpice(AlienPower):
    name: str = field(default="Sage_Spice", init=False)
...
AlienRegistry.register(Cinnamon())
AlienRegistry.register(Pepper())
AlienRegistry.register(Paprika())
AlienRegistry.register(ChiliSpice())
AlienRegistry.register(Rosemary())
AlienRegistry.register(Saffron())
AlienRegistry.register(Cardamom())
AlienRegistry.register(NutmegSpice())
AlienRegistry.register(Cloves())
AlienRegistry.register(SageSpice())
