"""
Asian Mythology Powers - Asian mythology themed aliens.
"""
...
@dataclass
class Dragon_Emperor(AlienPower):
    """Dragon_Emperor - Chinese Dragon King. +6 always."""
    name: str = field(default="Dragon_Emperor", init=False)
...
class Kitsune(AlienPower):
    """Kitsune - Fox Spirit. Random +1 to +6."""
...
class Tengu(AlienPower):
    """Tengu - Mountain Demon. +5 on offense."""
...
class Oni(AlienPower):
    """Oni - Japanese Ogre. +4 on offense."""
...
class Tanuki(AlienPower):
    """Tanuki - Raccoon Dog. See opponent card."""
...
class Tsukuyomi(AlienPower):
    """Tsukuyomi - Moon God. +4 on defense."""
...
class Raijin(AlienPower):
    """Raijin - Thunder God. +5 on offense."""
...
@dataclass
class Benzaiten(AlienPower):
    """Benzaiten - Goddess of Arts. Extra card draw."""
    name: str = field(default="Benzaiten", init=False)
...
@dataclass
class Bishamon(AlienPower):
    """Bishamon - War God. +4 on offense."""
    name: str = field(default="Bishamon", init=False)
    description: str = field(default="+4 when attacking.", init=False)
    timing: PowerTiming = field(default=PowerTiming.REVEAL, init=False)
    power_type: PowerType = field(default=PowerType.MANDATORY, init=False)
    category: PowerCategory = field(default=PowerCategory.GREEN, init=False)
...
@dataclass
class Ebisu(AlienPower):
    """Ebisu - Luck God. Random +2 to +6."""
    name: str = field(default="Ebisu", init=False)
...
@dataclass
class Daikoku(AlienPower):
    """Daikoku - Wealth God. +3 always."""
    name: str = field(default="Daikoku", init=False)
...
@dataclass
class Hotei(AlienPower):
    """Hotei - Contentment God. +2 per ally."""
    name: str = field(default="Hotei", init=False)
...
# Register all powers
ASIAN_MYTHOLOGY_POWERS = [
    Dragon_Emperor, Kitsune, Tengu, Oni, Tanuki, Amaterasu, Tsukuyomi, Susanoo,
    Raijin, Fujin, Benzaiten, Bishamon, Ebisu, Daikoku, Hotei,
]

for power_class in ASIAN_MYTHOLOGY_POWERS:
    try:
